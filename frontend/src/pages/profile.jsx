  ...
  return (
    <div className="flex flex-col items-center bg-neutral-800 text-neutral-50 dark:bg-neutral-200 dark:text-neutral-900 min-h-screen">
      ...
      <div className="flex flex-row justify-between m-5 space-x-3 mb-15">
        <Link to="/editprof"><Button variant="default" className="w-32 bg-purple-900 text-white dark:text-white hover:bg-purple-300">Update Profile</Button></Link>
        <Link to="/"><Button variant="default" className="w-32 bg-red-500 text-white hover:cursor-pointer hover:bg-red-200">Log Out</Button></Link>
        <Button variant="default" className="w-[32%] bg-red-500 text-white hover:cursor-pointer hover:bg-red-200">Delete Account</Button>
      </div>
    </div>
  )
}
